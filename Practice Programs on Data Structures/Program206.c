...
{
    PNODE newn = NULL; //(myn) pointer create kela malloc cha address ghenya karta
...
/*
   void InsertFirst(PPNODE Head, int no) //(myn)Head is the name of variable 
   void InsertLast(PPNODE Head, int no)
